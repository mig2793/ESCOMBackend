...
class EquiposController extends Controller
{
    ...
    public function getReportMaint($id)
    {
        $getMachineMainte =  Equipos::getReportMaint($id);
    ...
    public function insertMantenimi(Request $request)
    {
        $validateInsert = Equipos::insertMantenimi($request);
